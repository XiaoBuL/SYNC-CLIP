...
class OxfordPets(DatasetBase):
    ...
    def __init__(self, root, num_shots, subsample, dalle=True):
        ...
        train_u, val, test = self.read_split(self.split_path, self.image_dir)
        ...
        test_base = self.subsample_classes(test, subsample="base")[0]
        test_novel = self.subsample_classes(test, subsample="new")[0]
    ...
    @staticmethod
    def subsample_classes(*args, subsample="all", relabel=True):
        ...
        if relabel == True:
            ...
            relabeler = {y: y for y in selected}
